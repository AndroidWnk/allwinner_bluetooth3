...
import com.etrans.bluetooth.event.BackgroundCurrentNumberEvent;
import com.etrans.bluetooth.event.BackgroundHfpStatusEvent;
import com.etrans.bluetooth.event.CurrentNumberEvent;
import com.etrans.bluetooth.event.HfpStatusEvent;
...
public class IncomingActivity extends Activity implements OnClickListener {
	...
	public void onEvent(BackgroundCurrentNumberEvent event){
		Log.d("IncomingActivity","back number:" + event.number);
		currentNumber = event.number;
		updateNumber();
